import { addMonths as dateFnsAddMonths, addDays as dateFnsAddDays, isValid } from 'date-fns';
...
export const addDays = (date, days) => convertTzDate(dateFnsAddDays(date, days));
